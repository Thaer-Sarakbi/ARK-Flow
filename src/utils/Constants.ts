...
export const Places = [
  ...
  {value: 9, label: 'MELAWATHI H3', image: undefined},
  {value: 10, label: 'NEW RAWANG', image: require('@/assets/images/places/rawang.jpeg')},
  ...
  {value: 19, label: 'AMPANG H1', latitude: 3.1584280, longitude: 101.7500843, image: require('@/assets/images/places/ampangH1.jpeg')},
  {value: 20, label: 'DE GLORY', latitude: 3.0252123, longitude: 101.5819822, image: require('@/assets/images/places/deGlory.jpeg')},
  {value: 21, label: 'HARTAMAS H1', image: require('@/assets/images/places/hartamas.webp')},
  {value: 22, label: 'KAJANG STAR', latitude: 2.9900012, longitude: 101.7759714, image: require('@/assets/images/places/kajangStar.jpeg')},
  {value: 23, label: 'KDH 1', latitude: 3.1763414, longitude: 101.5751428, image: require('@/assets/images/places/kdh1.webp')},
  {value: 24, label: 'KDH 2', latitude: 3.1510098, longitude: 101.5757008, image: require('@/assets/images/places/kdh2.jpeg')},
  {value: 25, label: 'MELAKKA', image: require('@/assets/images/places/melacca.webp')},
  {value: 26, label: 'MELAWATHI H2', image: require('@/assets/images/places/melawatiH2.jpeg')},
  {value: 27, label: 'NEW KAJANG', image: require('@/assets/images/places/newRawang.jpeg')},
  ...
  {value: 35, label: 'ARK Porkdickson', image: ''},
